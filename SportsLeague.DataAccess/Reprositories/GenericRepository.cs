...
namespace SportsLeague.DataAccess.Reprositories
{
    public class GenericRepository<T> : IGenericRepository<T> where T : AuditBase
    {
        ...
        public async Task<T> CreateAsync(T entity)
        {
            ...
            await _context.SaveChangesAsync(); //Este método SaveChangesAsync () es crucial para que los cambios se reflejen en la DB
            return entity;
        }
